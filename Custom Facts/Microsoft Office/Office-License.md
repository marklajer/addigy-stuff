...
**Name:** Office License
**Description:** Reports the type of Microsoft Office license in use
**Return Type:** string
**Language:** bash
...
if [ "$PERPETUALPRESENT" == "Yes" ] && [ "$O365ACTIVATIONS" ]; then
	/bin/echo "Volume and Office 365 licenses detected. Only the volume license will be used."
	...
	/bin/echo "Office 365 activations: $O365ACTIVATIONS"
